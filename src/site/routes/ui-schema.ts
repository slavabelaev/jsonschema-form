...
export const uiSchema: Routes = {
    introduction: {
        hash: 'description',
        title: 'Введение',
        docsUrl: require( '../../docs/ui-schema/introduction.md' ),
    ...
    widget: {
        ...
        routes: {
            'attach': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/attach.md' ),
            ...
            'calendar': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/calendar.md' ),
            ...
            'card-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/card-input.md' ),
            ...
            'checkbox-group': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/checkbox-group.md' ),
            ...
            'checkbox': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/checkbox.md' ),
            ...
            'color-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/color-input.md' ),
            ...
            'date-time-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/date-time-input.md' ),
            ...
            'calendar-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/calendar-input.md' ),
            ...
            'email-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/email-input.md' ),
            ...
            'input-autocomplete': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/input-autocomplete.md' ),
            ...
            'input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/input.md' ),
            ...
            //     docsUrl: require( '../../docs/ui-schema/widgets/intl-phone-input.md' ),
            ...
            'money-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/money-input.md' ),
            ...
            'password-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/password-input.md' ),
            ...
            'phone-input': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/phone-input.md' ),
            ...
            'radio-group': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/radio-group.md' ),
            ...
            'select': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/select.md' ),
            ...
            'textarea': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/textarea.md' ),
            ...
            'toggle': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/toggle.md' ),
            ...
            'editor': {
                ...
                docsUrl: require( '../../docs/ui-schema/widgets/editor.md' ),
    ...
    keywords: {
        ...
        routes: {
            rootFieldId: {
                docsUrl: require( '../../docs/ui-schema/rootFieldId.md' ),
                docsEditPath: 'src/docs/ui-schema/rootFieldId.md'
            },
            classNames: {
                docsUrl: require( '../../docs/ui-schema/classNames.md' ),
                docsEditPath: 'src/docs/ui-schema/classNames.md'
            },
            title: {
                docsUrl: require( '../../docs/ui-schema/title.md' ),
                docsEditPath: 'src/docs/ui-schema/title.md'
            },
            description: {
                docsUrl: require( '../../docs/ui-schema/description.md' ),
            ...
            autofocus: {
                ...
                docsUrl: require( '../../docs/ui-schema/autofocus.md' ),
                docsEditPath: 'src/docs/ui-schema/autofocus.md'
            },
            disabled: {
                docsUrl: require( '../../docs/ui-schema/disabled.md' ),
                docsEditPath: 'src/docs/ui-schema/disabled.md'
            },
            enumDisabled: {
                docsUrl: require( '../../docs/ui-schema/enumDisabled.md' ),
            ...
            order: {
                ...
                docsUrl: require( '../../docs/ui-schema/order.md' ),
                docsEditPath: 'src/docs/ui-schema/order.md'
            },
            label: {
                docsUrl: require( '../../docs/ui-schema/label.md' ),
            ...
            gridColumn: {
                ...
                docsUrl: require( '../../docs/ui-schema/gridColumn.md' ),
